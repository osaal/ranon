...
`ranon` is a package for inspecting human data sets for anonymity. It is in early development.
...
You can install the development version of ranon from [GitHub](https://github.com/) with:
...
The development package uses `renv` for environment management. Install the necessary development packages locally with:
